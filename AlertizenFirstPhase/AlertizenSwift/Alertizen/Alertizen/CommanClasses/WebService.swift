...
class WebService: NSObject {
    ...
    private let baseURL = "http://app.miinex.com/webservices/index.php/data/"
//    private let baseURL = "http://cloudart.com.au/projects/stack_ios/index.php"
    
//    private let baseURL = "https://itunes.apple.com/search?term=Beatles&media=music&entity=album"
...
//        self.callGetAPI("\(baseURL)\(strUrl)")
    ...
    func postMethodWithParams(dict:NSDictionary, completionHandler:(_ dict :NSDictionary) -> Void) -> Void {
        
        let request = self.PostWithParamAndImage(dictParam: dict, file: nil, fileKey: nil, fileName: nil)
    ...
    func postMethodWithParamsAndImage(dictParams: NSDictionary, image: UIImage?, imagesKey: String, imageName:String,completionHandler:@escaping (_ dict :NSDictionary) -> Void, failue:@escaping (_ error: String) -> Void)
    {
        let request = self.PostWithParamAndImage(dictParam: dictParams, file: image, fileKey: imagesKey, fileName: imageName)
    ...
    private func PostWithParamAndImage(dictParam: NSDictionary, file: UIImage?, fileKey: String?, fileName: String?) -> NSURLRequest
    {
        let myUrl = NSURL(string: "http://www.swiftdeveloperblog.com/http-post-example-script/") // Replace with base url
