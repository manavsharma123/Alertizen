...
public class  ISRadioButton: UIButton {
    ...
    @IBInspectable public var iconColor:UIColor =  UIColor(red: (55.0/255.0), green: (55/255.0), blue: (55/255.0), alpha: 1.0)
    ...
    @IBInspectable public var indicatorColor:UIColor =  UIColor(red: (55.0/255.0), green: (55/255.0), blue: (55/255.0), alpha: 1.0)
